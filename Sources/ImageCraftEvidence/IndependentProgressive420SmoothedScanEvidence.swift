...
private struct IndependentProgressive420SmoothedGeneration: Codable {
  let scanNumber: Int
  let byteCount: Int
  let sha256: String
  let fileName: String
...
private struct IndependentProgressive420SmoothedScanEvidenceReport: Codable {
  ...
  let generations: [IndependentProgressive420SmoothedGeneration]
}

func writeIndependentProgressive420SmoothedScanEvidence(
  input: URL,
  outputDirectory: URL
) throws {
  ...
  var generations: [IndependentProgressive420SmoothedGeneration] = []
  ...
  let decoded = try JPEGIndependentProgressive420Decoder(
    ...
    data,
    scanPreviewPolicy: .libjpegBlockSmoothing,
    scanPreviewObserver: { scanNumber, pixels in
      ...
      generations.append(
        IndependentProgressive420SmoothedGeneration(
  ...
  let report = IndependentProgressive420SmoothedScanEvidenceReport(
    schemaVersion: 1,
    evidenceVersion: "imagecraft-independent-progressive-jpeg-420-smoothed-scans-v1",
